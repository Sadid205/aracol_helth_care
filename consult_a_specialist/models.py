...
class ConsultASpecialist(models.Model):
    patient = models.ForeignKey("patient.Patient",related_name="consult_a_specialist",on_delete=models.CASCADE)
    doctor = models.OneToOneField("doctor.Doctor",related_name="consult_a_specialist",on_delete=models.CASCADE)
