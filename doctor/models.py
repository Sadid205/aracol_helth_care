...
from .doctor_choices import GENDER,DOCTOR_TYPE,DAYS,STATUS,ROLE
...
class Doctor(models.Model):
    ...
    instance_consultation_start_time = models.TimeField(auto_now=False,auto_now_add=False,blank=True,null=True,)
    instance_consultation_end_time = models.TimeField(auto_now=False,auto_now_add=False,blank=True,null=True,)
    instance_consultation_start_day = models.CharField(choices=DAYS,default="sat",blank=True,null=True,max_length=10)
    instance_consultation_end_day = models.CharField(choices=DAYS,default="sri",blank=True,null=True,max_length=10)
    apointment_consultation_start_time = models.TimeField(auto_now=False,auto_now_add=False,blank=True,null=True,)
    apointment_consultation_end_time = models.TimeField(auto_now=False,auto_now_add=False,blank=True,null=True,)
    apointment_consultation_start_day = models.CharField(choices=DAYS,default="sat",blank=True,null=True,max_length=10)
    apointment_consultation_end_day = models.CharField(choices=DAYS,default="sri",blank=True,null=True,max_length=10)
    ...
    role = models.CharField(choices=ROLE,max_length=20,default="doctor")
